 ...
 *  chọn Sáng/Tối (xem ThemePrefs.kt).
 *  Tính năng "Ghi âm cuộc gọi" (tự động ra lệnh cho VOX Ghi Âm) đã bị GỠ BỎ hoàn toàn khỏi app -
 *  xem InCallActivity.kt, nút ghi âm trên trang gọi giờ chỉ báo "đang phát triển". */
